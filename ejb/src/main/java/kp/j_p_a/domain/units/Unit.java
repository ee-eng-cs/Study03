...
public class Unit implements Comparable<Unit> {
	...
	public Unit(String id) {
		super();
		this.id = id;
		this.sides.put(CardinalDirection.NORTH, new Side());
		this.sides.put(CardinalDirection.EAST, new Side());
		this.sides.put(CardinalDirection.SOUTH, new Side());
		this.sides.put(CardinalDirection.WEST, new Side());
	}
